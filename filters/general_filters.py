...
general_constraints = [
    ...
    {"column_name": "rows_post", "description": "Rows after event", "filter_group": "general", "extract_period": None,
     "value": None, "min_value": None, "max_value": None, "type": "int8"},
    {"column_name": "p1_value", "description": "Point 1 Value", "filter_group": "general", "extract_period": None,
     "value": None, "min_value": None, "max_value": None, "type": "numeric"},
    {"column_name": "p2_value", "description": "Point 2 Value", "filter_group": "general", "extract_period": None,
     "value": None, "min_value": None, "max_value": None, "type": "numeric"},
    {"column_name": "p3_value", "description": "Point 3 Value", "filter_group": "general", "extract_period": None,
     "value": None, "min_value": None, "max_value": None, "type": "numeric"},
    {"column_name": "p4_value", "description": "Point 4 Value", "filter_group": "general", "extract_period": None,
     "value": None, "min_value": None, "max_value": None, "type": "numeric"},
